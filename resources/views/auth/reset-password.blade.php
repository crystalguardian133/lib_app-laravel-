...
<head>
    ...
    <title>Reset Password - Julita Public Library</title>
    ...
    <div class="reset-card">
        ...
        <form method="POST" action="{{ route('password.reset') }}">
            ...
            <div class="form-group">
                <label for="password">
                    <i class="fas fa-lock" style="color: var(--primary); margin-right: 8px;"></i> New Password
                </label>
            ...
            <div class="form-group">
                <label for="password_confirmation">
                    <i class="fas fa-lock" style="color: var(--primary); margin-right: 8px;"></i> Confirm Password
                </label>
                <div class="password-input-wrapper">
                    <input 
                        type="password" 
