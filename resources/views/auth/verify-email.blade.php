...
<head>
    ...
    <title>Verify Email - Julita Public Library</title>
    ...
    <style>
        ...
        * {
        ...
        @keyframes pulse {
            ...
            50% {
                box-shadow: 0 0 40px rgba(47, 185, 235, 0.5);
            }
        }
...
<body>
    ...
    <div class="verify-card">
        <div class="verify-header">
            ...
            <p>Confirm your identity to reset your password</p>
        </div>
        ...
        <form method="POST" action="{{ route('password.verify-email.post') }}">
            @csrf
            ...
            <div class="info-box">
                <i class="fas fa-info-circle"></i> A verification link has been sent to your email. Please enter the token from the link to proceed.
            </div>

            <div class="form-group">
                <label for="token">
                    <i class="fas fa-key" style="color: var(--primary); margin-right: 8px;"></i> Verification Token
                </label>
                <input 
                    type="text" 
                    id="token" 
            ...
            <button type="submit" class="btn-submit">
                <i class="fas fa-check-circle" style="margin-right: 8px;"></i> Verify & Continue
            </button>
        </form>

        <div class="back-link">
            <a href="{{ route('password.forgot') }}">
                <i class="fas fa-arrow-left" style="margin-right: 6px;"></i> Request New Link
            </a>
        </div>
    </div>
