...
@endif
    ...
    <script>
        ...
        // Prevent accidental double-submit on force logout actions.
        document.querySelectorAll('.force-logout-form').forEach(form => {
            form.addEventListener('submit', function () {
                const button = form.querySelector('.action-btn-logout');
                if (!button) return;
